...
dotnet script ./GradientSoftware.GithubScripts/.github/scripts/update-version.csx %GITHUB_USERNAME% GradientSoftware.CryptoAnalysis %GITHUB_APIKEY% .\CryptoAnalysis\CryptoAnalysis.csproj %branch%
