namespace Gradient.CryptoAnalysis.Tests
{
    ...
    public class IsSuccessiveGreenCandlesConditionTests
    {
        ...
        public void TestIsSuccessiveGreenCandlesCondition()
        {
            ...
            data[0].Open = 100.0; data[0].Close = data[0].Open - 10.0;
            data[1].Open = 50.0; data[1].Close = data[1].Open + 10.0; // 1
            data[2].Open = 100.0; data[2].Close = data[2].Open - 10.0;
            data[3].Open = 50.0; data[3].Close = data[3].Open + 10.0; // 1
            data[4].Open = 100.0; data[4].Close = data[4].Open + 10.0; // 2
            data[5].Open = 200.0; data[5].Close = data[5].Open + 10.0; // 3
            data[6].Open = 400.0; data[6].Close = data[6].Open + 10.0; // 4
            data[7].Open = 100.0; data[7].Close = data[7].Open - 10.0;
            data[8].Open = 200.0; data[8].Close = data[8].Open + 10.0; // 1
