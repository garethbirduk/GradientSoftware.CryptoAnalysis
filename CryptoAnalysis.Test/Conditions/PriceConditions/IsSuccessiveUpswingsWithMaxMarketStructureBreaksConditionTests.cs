...
{
    [TestClass]
    public class IsSuccessiveUpswingsWithMaxMarketStructureBreaksConditionTests
    {
        private List<Price> _prices;
        public static readonly string _cryptoDataFilePath = Path.Combine("TestData", "Conditions", "PriceConditions", "IsSuccessiveUpswingsWithMaxMarketStructureBreaksCondition.csv");

        [TestMethod]
        public void Test1()
        {
            var conditionSet = new ConditionSet();
            conditionSet.AndConditions.Add(new IsSuccessiveUpswingsWithMaxMarketStructureBreaksCondition(10, 3, 1, 25));
